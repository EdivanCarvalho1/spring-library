...
public class SecurityConfig {
    ...
    SecurityFilterChain securityFilterChain(HttpSecurity http) throws Exception {
        http
            ...
            .authorizeHttpRequests(auth -> auth
                .requestMatchers("/auth/login", "/admin/registrar", "/livros/list", "/livros/search", "/user/registrar", "/admin/info", "/user/info").permitAll()
    ...
    public AuthenticationManager authManager(HttpSecurity http) throws Exception {
        ...
        authenticationManagerBuilder.userDetailsService(bibliotecarioService).passwordEncoder(passwordEncoder());
